...
export function AdminSidebar({
  ...
  const headerAppearanceActive = pathname === "/admin/header-appearance"
        ...
        <nav className="flex-1 overflow-y-auto px-4 py-6 space-y-6 scrollbar-thin">
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <Link
                href="/admin/header-appearance"
                className={`
                group flex items-center justify-between rounded-xl px-3 py-2.5 text-[13px] font-medium transition-all
                ${headerAppearanceActive ? "bg-[#38BDF8]/10 text-[#38BDF8]" : "text-zinc-500 hover:bg-zinc-50 hover:text-zinc-900"}
              `}
              >
                <div className="flex items-center gap-3">
                  <span
                    className={`text-[15px] shrink-0 transition-colors ${headerAppearanceActive ? "text-[#38BDF8]" : "text-zinc-300 group-hover:text-zinc-500"
                      }`}
                  >
                    <FaPalette />
                  </span>
                ...
                {headerAppearanceActive ? <div className="h-1.5 w-1.5 rounded-full bg-[#38BDF8]" /> : null}
              </Link>
            </div>
          </div>
